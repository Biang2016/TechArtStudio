...
Shader "VertexManipulationDemo"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 appendResult13 = (float4(( ( ( sin( ( ( _Time.y * _Frequency ) + _OffsetTime + ( _FlapTimeOffset * ase_vertex3Pos.z * -1 ) ) ) * _Amplitude ) + _OffsetAmplitude ) * ase_vertex3Pos.z * ase_vertex3Pos.z * _FlapScalar ) , 0.0 , 0.0 , 0.0));
...
/*ASEBEGIN
Version=17500
0;40;1358;800;2362.116;348.5874;1.591472;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1528.108,-86.67307;Inherit;False;Property;_Frequency;Frequency;1;0;Create;True;0;0;False;0;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1781.351,293.9122;Inherit;False;Property;_FlapTimeOffset;FlapTimeOffset;6;0;Create;True;0;0;False;0;0;0.02;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-1207.108,86.32708;Inherit;False;Property;_Amplitude;Amplitude;3;0;Create;True;0;0;False;0;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-930.1207,472.932;Inherit;False;Property;_FlapScalar;FlapScalar;5;0;Create;True;0;0;False;0;0;0.1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-502.8072,248.4922;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;13;-202.6461,248.2142;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.AbsOpNode;16;-1613.508,449.7422;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=9B5E111A6FA05501515060C5FE88173235DA4794